...
EVENTS = [
    ...
    {"name": "Recession Hits", "effects": {"economy": -8}},
    {
        ...
        "effects": {"stability": -15, "military": 5},
    },
    {
    ...
    {
        "name": "Cyber Attack Cripples Infrastructure",
        "effects": {"technology": -8, "stability": -4},
    },
    {
        "name": "Natural Disaster Strikes",
        "effects": {"economy": -6, "stability": -6, "population": -2},
    },
    {"name": "Population Boom", "effects": {"population": 5}},
    {
        "name": "Pandemic Outbreak",
        "effects": {"population": -8, "economy": -5},
    },
    ...
    {"name": "Successful Diplomatic Summit", "effects": {"stability": 6}},
    {
        ...
        "effects": {"military": 8, "economy": -3},
    },
    {
        "name": "Research Grant Windfall",
        "effects": {"technology": 6, "economy": 2},
    },
    {"name": "Civil Unrest", "effects": {"stability": -12}},
    {"name": "Military Modernization Program", "effects": {"military": 7}},
    {
        "name": "Drought Damages Agriculture",
        "effects": {"economy": -4, "population": -1},
    },
    {"name": "Global Trade Boycott", "effects": {"economy": -7}},
    {
        "name": "Space Program Success",
        "effects": {"technology": 9, "stability": 2},
    },
    {
        "name": "Terrorist Attack",
        "effects": {"stability": -8, "military": 3},
    },
    {
        "name": "Energy Crisis",
        "effects": {"economy": -5, "stability": -3},
    },
]


def get_random_event():
    """Return a randomly chosen event dict from EVENTS."""
